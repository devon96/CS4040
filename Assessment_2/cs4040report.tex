...
As the mitigations for those vulnerabilities described in previous sections heavily modify or straight-up disable a lot of performance features present in modern CPUs, it will be necessary to perform benchmarking on CPU themselves with and without those mitigations installed. In order to answer the research question and evaluate how big and whether meaningful the impact was, we can devise the following null hypotheses: 
\begin{itemize}
